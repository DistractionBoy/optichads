...
const people: Person[] = [
  {
    name: "Mathus Travelstein",
    role: "Guild Master",
    imageUrl: guildMaster,
    twitterUrl: "https://twitter.com/DistractionBoy_",
    quixoticUrl: "",
  },
  {
    name: "Cryptovanian #1009",
    role: "Truth Teller",
    imageUrl: loreMaster,
    twitterUrl: "https://twitter.com/luisotravz",
    quixoticUrl: "",
  },
  {
    name: "Steve",
    role: "Definitely Not Vampire",
    imageUrl: steve,
    twitterUrl: "https://twitter.com/DistractionBoy_",
    quixoticUrl: "",
  },
        ...
        <div className="space-y-12">
          <div className="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
            ...
            <p className="text-xl text-gray-300">
              Would you like to join us? We could always use a fresh face. Our
              world is skrinking...
            </p>
          </div>
          <ul
                  ...
                  <div className="space-y-2 xl:flex xl:items-center xl:justify-between">
                    ...
                    <ul role="list" className="flex justify-center space-x-5">
                      ...
                      {person.quixoticUrl && (
                        <li>
                          <a
                            href={person.quixoticUrl}
                            className="text-gray-400 hover:text-gray-300"
                          >
                            <span className="sr-only">Quixotic</span>
                            <Image
                              className="w-5 h-5"
