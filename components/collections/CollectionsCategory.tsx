...
const GROUPS = [
  {
    ...
    shortDescription: "Once upon a time, in the far-off land of Chadtopia, there lived a legendary figure known as Armored Chad" +
    ...
    description: "Armored Chad was a towering figure, with bulging muscles and a sharp, tactical mind. " +
  ...
  },
  {
    ...
    bgColor: "bg-[#FB0420]",
    bgDescription: "bg-red-600",
    shortDescription: "The Demon King was a master of deception and manipulation, and he would often take on different forms to deceive his enemies." +
    ...
    description: "In the beginning, there was only chaos and darkness. From this void emerged the Demon King, "+
  ...
  },
  {
    ...
    shortDescription: "In the land of Arbitrum, there lived a fierce and powerful warrior known as the Berserker. "+
    ...
    description: "The Berserker was known for her unpredictable and frenzied fighting style. "+ 
  ...
  },
  {
    ...
    bgColor: "bg-blue-500",
    bgDescription: "bg-blue-400",
    shortDescription: "The Succubus was a master of manipulation and deception. She would often take on the form of a beautiful woman, "+
    ...
    description: "In the dark and mysterious realm of the supernatural, there lived a creature of unmatched beauty and allure. "+
  ...
  },
  {
    ...
    shortDescription: "In the land of Brigader, where magic was a part of everyday life, there lived a young wizard named Cool. "+
    ...
    description: "While other wizards were content with simply casting spells and waving their wands, "+
  ...
  },
  {
    ...
    bgColor: "bg-indigo-500",
    bgDescription: "bg-indigo-400",
    shortDescription: "Once upon a time, in the mystical land of Brigader, there was a kingdom ruled by a wise and just king named Base King. "+
    ...
    description: "However, one day, a powerful sorcerer named Malachi arrived in Brigader. "+
