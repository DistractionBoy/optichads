import { FrameMetadataType } from "@/pages/api/types";
...
export function FrameMetadata({
  ...
  const postUrlToUse = postUrl || postUrl;
  const refreshPeriodToUse = refreshPeriod || refreshPeriod;
  ...
  return (
    <Wrapper>
      ...
      {!!(
        button1 &&
        (button1.action == "link" || button1.action == "mint")
      ) && (
      ...
      {!!(
        button2 &&
        (button2.action == "link" || button2.action == "mint")
      ) && (
      ...
      {!!(
        button3 &&
        (button3.action == "link" || button3.action == "mint")
      ) && (
      ...
      {!!(
        button4 &&
        (button4.action == "link" || button4.action == "mint")
      ) && (
