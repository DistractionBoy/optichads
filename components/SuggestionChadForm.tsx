  ...
  return (
    <div className="lg:py-24">
      ...
      <p className="mt-3 text-base text-gray-200 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
        Hey, sup. Soon we are going to be airdropping $OP to holders who
        complete weekly Proof of Work quests but in the meantime, pull up a
        bench and see what makes us great.
      </p>
