...
export const TracingBeam = ({
  ...
  return (
    ...
    >
      <div className="absolute -left-2 sm:-left-4 md:-left-6 lg:-left-8 xl:-left-32 top-3">
        <motion.div
          transition={{
            duration: 0.2,
            delay: 0.5,
        ...
        >
          ...
          <defs>
            ...
            >
              <stop stopColor="#FB0420" stopOpacity="0"></stop>
              <stop stopColor="#FB0420"></stop>
              <stop offset="0.325" stopColor="#D82f2c"></stop>
              <stop offset="1" stopColor="#Ff4865" stopOpacity="0"></stop>
            </motion.linearGradient>
          </defs>
        </svg>
      </div>
